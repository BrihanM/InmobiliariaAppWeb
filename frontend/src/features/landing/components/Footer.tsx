...
const FOOTER_LINKS = [
  ...
  },
  {
    title: 'Soporte',
    links: [
      { label: 'Centro de ayuda', to: '/properties' },
      { label: 'Términos y condiciones', to: '/properties' },
      { label: 'Privacidad', to: '/properties' },
      { label: 'Cookies', to: '/properties' },
    ],
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-slate-500 text-sm">
            &copy; {year} {env.appName}. Todos los derechos reservados.
          </p>
          <div className="flex items-center gap-3">
            {SOCIAL_LINKS.map((social) => (
              <a
                ...
                className="w-9 h-9 bg-slate-800 hover:bg-indigo-600 rounded-lg flex items-center justify-center transition-colors text-slate-400 hover:text-white"
